        ...
        <div className="flex gap-8">
          {[
            ...
            <button
              ...
              className={`pb-4 text-xs font-black uppercase tracking-[0.2em] flex items-center gap-3 transition-all border-b-4 ${activeTab === tab.id ? 'border-indigo-600 text-indigo-900' : 'border-transparent text-slate-400 hover:text-slate-600'
                }`}
            >
