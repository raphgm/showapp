...
const ExtensionHub: React.FC = () => {
  return (
    <div className="p-10 max-w-6xl mx-auto space-y-12 animate-in fade-in duration-500 relative">
      <PageDoodles />
      <HeroBanner 
        title={<>Command the Web <br />from your Toolbar.</>}
        description="The Show Extension is your high-performance bridge between any website and your Show Studio. Record, snap, and share without switching tabs."
