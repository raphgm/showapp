...
echo -e "  ${BOLD}Live:${RESET}   https://getshowapp.com"
echo -e "  ${BOLD}CI/CD:${RESET}  https://github.com/raphgm/showapp/actions"
echo ""
echo -e "  GitHub Actions will build & deploy to Hostinger (getshowapp.com) via FTP."
echo -e "  Check the Actions tab for build status (~2 min)."
echo ""
