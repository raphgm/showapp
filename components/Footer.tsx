          ...
          <div className="lg:col-span-5 space-y-10">
            <div className="space-y-6">
              ...
              <p className="text-lg text-slate-400 font-medium leading-relaxed max-w-sm">
                The high-performance operating system for cognitive scale. Capture your vision, organize with AI. <span className="font-bold block mt-2"><span className="text-black">Show. Don't Just Meet.</span></span>
              </p>
            </div>
            
            <button 
              onClick={() => onNavigate(AppRoute.EXTENSION)}
              className="flex items-center gap-3 px-6 h-10 bg-indigo-50 border border-indigo-100 text-indigo-600 rounded-xl font-black text-[10px] uppercase tracking-widest hover:bg-indigo-600 hover:text-white transition-all shadow-sm"
            >
          ...
          <div className="flex items-center gap-12">
            {[
              ...
              <button 
                ...
                className="text-[11px] font-black text-slate-400 hover:text-indigo-600 uppercase tracking-[0.35em] transition-colors"
              >
                {social.name}
              </button>
            ))}
