...
import { 
  ...
  Sparkles, Fingerprint, ShieldCheck, AlertCircle
} from 'lucide-react';
import Logo from './Logo';
import { signInWithEmail, signInWithGoogle, signInWithGitHub } from '../services/firebase';
        ...
        <div className="bg-white rounded-[48px] shadow-[0_40px_100px_-20px_rgba(79,70,229,0.15)] border border-slate-100 p-12 relative overflow-hidden">
          ...
          <div className="flex flex-col items-center text-center mb-10">
            ...
            <div className="space-y-2">
              ...
              <p className="text-slate-400 font-medium">Access your Show Studio.</p>
            </div>
          </div>
          ...
          <div className="mt-10 pt-10 border-t border-slate-50 space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <button onClick={handleGoogleSignIn} disabled={isLoading} className="flex items-center justify-center gap-3 py-3 border-2 border-slate-50 rounded-2xl hover:border-indigo-100 hover:bg-indigo-50/50 transition-all group disabled:opacity-50">
              ...
              <button onClick={handleGitHubSignIn} disabled={isLoading} className="flex items-center justify-center gap-3 py-3 border-2 border-slate-50 rounded-2xl hover:border-slate-900 hover:bg-slate-900 hover:text-white transition-all group disabled:opacity-50">
