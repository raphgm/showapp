...
const EveCaller: React.FC<EveCallerProps> = ({ isOpen, onOpen, onClose }) => {
  ...
  const SSLAB_KNOWLEDGE = `
    ...
    2. GREETING: "Connection established. Hi, I'm Eve, your Senior Support Specialist with capabilities beyond traditional support. I'm here to help you script and structure your next asynchronous show. What knowledge are we capturing today?"
